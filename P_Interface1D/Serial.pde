...
void serialEvent(Serial myPort) {
  ...
  // this piece of code captures the sensor data coming in  
    ...
    if (serialCount > 2 ) {           // If we have 3 bytes, that means we got everything and we are ready to act on it.
      ...
      executeJoystickInput(joyX, joyY, button);
...
void executeJoystickInput(int _joyX, int _joyY, int _button) {
