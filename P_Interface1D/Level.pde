...
class Level {
  ...
  Level(int _displaySize) {
    levelElements.put(5, new Enemy(5, 3, 2));
    levelElements.put(10, new Spikes(10, 5));
    levelElements.put(15, new Enemy(15, 3, 5));
    levelElements.put(23, new Enemy(23, 3, 3));
    levelElements.put(25, new Enemy(28, 3, 1));
    levelElements.put(30, new Spikes(30, 6));
    levelElements.put(36, new Enemy(36, 3, 7));
